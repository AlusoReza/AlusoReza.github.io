...
### Predominantly single quotes (158 single vs 98 double) — WARNING
- **Source:** check-js-logic.ps1
- **Detected:** Session ?
- **Description:** Predominantly single quotes (158 single vs 98 double)
- **Status:** ⏳ Pending
...
### Classes referenced but missing CSS: text-xs, nav-toggle, mx-auto, nav-container, nav-link, nav-bar, lang-btn, sidebar-name-first, nav-links, lang-switcher, nav-overlay — WARNING
- **Source:** check-css-logic.ps1
- **Detected:** Session ?
- **Description:** Classes referenced but missing CSS: text-xs, nav-toggle, mx-auto, nav-container, nav-link, nav-bar, lang-btn, sidebar-name-first, nav-links, lang-switcher, nav-overlay
- **Status:** ⏳ Pending
...
### Missing keys in lang.json.es: nav-inicio, hero-sub, cv-text-h, cv-text-f, sec-hab, sec-cont, cont-sub — WARNING
- **Source:** check-json-schema.ps1
- **Detected:** Session ?
- **Description:** Missing keys in lang.json.es: nav-inicio, hero-sub, cv-text-h, cv-text-f, sec-hab, sec-cont, cont-sub
- **Status:** ⏳ Pending

### Missing keys in lang.json.en: nav-inicio, hero-sub, cv-text-h, cv-text-f, sec-hab, sec-cont, cont-sub — WARNING
- **Source:** check-json-schema.ps1
- **Detected:** Session ?
- **Description:** Missing keys in lang.json.en: nav-inicio, hero-sub, cv-text-h, cv-text-f, sec-hab, sec-cont, cont-sub
- **Status:** ⏳ Pending
...
### Classes referenced but missing CSS: sidebar-name-first, nav-container, text-xs, nav-link, mx-auto, nav-bar, nav-overlay, nav-links, lang-switcher, lang-btn, nav-toggle — WARNING
- **Source:** check-css-logic.ps1
- **Detected:** Session ?
- **Description:** Classes referenced but missing CSS: sidebar-name-first, nav-container, text-xs, nav-link, mx-auto, nav-bar, nav-overlay, nav-links, lang-switcher, lang-btn, nav-toggle
- **Status:** ⏳ Pending
