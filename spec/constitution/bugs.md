...
### Nav.astro sin data-lang o con onclick — ERROR
- **Source:** check-mcp.ps1
- **Detected:** Session ?
- **Description:** Nav.astro sin data-lang o con onclick
- **Status:** ⏳ Pending
...
### Predominantly single quotes (372 single vs 88 double) — WARNING
- **Source:** check-js-logic.ps1
- **Detected:** Session ?
- **Description:** Predominantly single quotes (372 single vs 88 double)
- **Status:** ⏳ Pending
...
## 📡 Automatic findings (Session ? — 2026-07-19)
